...
public class IntroduccionActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btnSiguiente = findViewById(R.id.btnIntroSiguiente);
        btnRegresar = findViewById(R.id.btnIntroRegresar);
        email = findViewById(R.id.editEmailTr);
        ...
        btnSiguiente.setOnClickListener(view -> {
            if(Validacion()) {
                ...
                editor.apply();
                Intent intent = new Intent(this, AbsoluteContraindicationsActivity.class);
                intent.addFlags(Intent.FLAG_ACTIVITY_CLEAR_TOP);
                intent.addFlags(Intent.FLAG_ACTIVITY_NEW_TASK);
