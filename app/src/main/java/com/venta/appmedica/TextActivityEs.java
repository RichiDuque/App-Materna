...
public class TextActivityEs extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_text_es);
        ...
        btnRegresarT.setOnClickListener(view -> {
            Intent intent = new Intent(this, RadioButton3ActivityEs.class);
