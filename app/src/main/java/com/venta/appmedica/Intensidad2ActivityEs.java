...
public class Intensidad2ActivityEs extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_intensidad2_es);
        ...
        btnRegresar.setOnClickListener(view -> {
            Intent intent = new Intent(this, IntensidadActivityEs.class);
