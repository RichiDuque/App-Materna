...
public class DeclarationActivityEs extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_declaration_es);
        ...
        btnRegresar.setOnClickListener(view -> {
            Intent intent = new Intent(this, Intensidad3ActivityEs.class);
